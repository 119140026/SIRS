...
public class subquery extends javax.swing.JFrame {
    ...
    public void loadData(){
        ...
        try{
            ...
            String sql = "SELECT Id_Pasien, Nama_Pasien, Alamat_Pasien from pasien where Umur = (select max(Umur) from pasien)";
